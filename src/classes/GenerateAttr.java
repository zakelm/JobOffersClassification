...
/**
 * Class to generate attributes arrf files
 *
 */
public class GenerateAttr {
	...
	public void arffHeader( String file, String classes, String classeType ) throws FileNotFoundException {
			...
			writer.println( "@attribute " + classeType.replace( "[", "" ).replace( "]", "" ).replace( ",", "" ) );//this is just the easy way you may need to replace those to text String
			writer.print( "\n" );
			writer.println( "@data" );
			writer.flush();
	}
