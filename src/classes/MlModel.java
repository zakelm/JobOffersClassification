...
public class MlModel {
	...
	public void loadArff( String fileName ) {
		...
		System.out.println( "Problème trouvé à " + fileName );			
	    }
	}
	...
	public void evaluate() {
		...
		System.err.println( "Problème trouvé " + e.getStackTrace() );
	    }
	}	
	...
	public void train() {
		...
		Instances trainingDataFiltered = weka.filters.Filter.useFilter( trainData, filter ); 
	...
	public void saveModel( String fileName ) {
		...
		System.out.println( "Problème trouvé " + e.getMessage() );
	    }
	}
}
